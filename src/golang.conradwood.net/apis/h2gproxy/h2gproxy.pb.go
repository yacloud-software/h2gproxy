...
const (
	Anchor_ABSOLUTE Anchor = 0
	Anchor_FROM_END Anchor = 1
	Anchor_TO_END   Anchor = 2
)

var Anchor_name = map[int32]string{
	0: "ABSOLUTE",
	1: "FROM_END",
	2: "TO_END",
}
var Anchor_value = map[string]int32{
	"ABSOLUTE": 0,
	"FROM_END": 1,
	"TO_END":   2,
}
...
func (x Anchor) String() string {
	return proto.EnumName(Anchor_name, int32(x))
}
func (Anchor) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type ByteRange struct {
	...
	Anchor Anchor `protobuf:"varint,3,opt,name=Anchor,enum=h2gproxy.Anchor" json:"Anchor,omitempty"`
}
...
func (m *ByteRange) GetStart() uint64 {
	if m != nil {
		return m.Start
	}
	return 0
...
func (m *ByteRange) GetEnd() uint64 {
	if m != nil {
		return m.End
	}
	return 0
...
func (m *ByteRange) GetAnchor() Anchor {
	if m != nil {
		return m.Anchor
	}
...
type BrowserConfig struct {
	UseNewStreamer bool `protobuf:"varint,1,opt,name=UseNewStreamer" json:"UseNewStreamer,omitempty"`
}
...
func (*BrowserConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

func (m *BrowserConfig) GetUseNewStreamer() bool {
	if m != nil {
		return m.UseNewStreamer
	}
	return false
}
...
func (*ApplyConfigRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*ApplyConfigResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*AddConfigResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }

// a stupid copy of the config file - must match TCPProxy
type AddConfigTCPRequest struct {
	...
	NeedAuth          bool   `protobuf:"varint,7,opt,name=NeedAuth" json:"NeedAuth,omitempty"`
	EntryPoint        uint32 `protobuf:"varint,8,opt,name=EntryPoint" json:"EntryPoint,omitempty"`
}
...
func (*AddConfigTCPRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (m *AddConfigTCPRequest) GetEntryPoint() uint32 {
	if m != nil {
		return m.EntryPoint
	}
	return 0
...
// config-parsing is a bit lame: this must match AddConfigTCPRequest
type TCPProxy struct {
	...
	AddHeaderToTCP   bool   `protobuf:"varint,5,opt,name=AddHeaderToTCP" json:"AddHeaderToTCP,omitempty"`
	EnableTLS        bool   `protobuf:"varint,6,opt,name=EnableTLS" json:"EnableTLS,omitempty"`
	Notimpl          bool   `protobuf:"varint,7,opt,name=notimpl" json:"notimpl,omitempty"`
	EntryPoint       uint32 `protobuf:"varint,8,opt,name=EntryPoint" json:"EntryPoint,omitempty"`
}
...
func (*TCPProxy) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (m *TCPProxy) GetEnableTLS() bool {
	if m != nil {
		return m.EnableTLS
	}
	return false
...
func (m *TCPProxy) GetNotimpl() bool {
	if m != nil {
		return m.Notimpl
	}
	return false
...
func (m *TCPProxy) GetEntryPoint() uint32 {
	if m != nil {
		return m.EntryPoint
	}
	return 0
...
// the header send to the backend at the start of a tcp connection
type TCPStart struct {
	...
	WithTLS        bool   `protobuf:"varint,6,opt,name=WithTLS" json:"WithTLS,omitempty"`
	NotImplemented bool   `protobuf:"varint,7,opt,name=NotImplemented" json:"NotImplemented,omitempty"`
	EntryPoint     uint32 `protobuf:"varint,8,opt,name=EntryPoint" json:"EntryPoint,omitempty"`
}
...
func (*TCPStart) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (m *TCPStart) GetWithTLS() bool {
	if m != nil {
		return m.WithTLS
	}
	return false
...
func (m *TCPStart) GetNotImplemented() bool {
	if m != nil {
...
func (m *TCPStart) GetEntryPoint() uint32 {
	if m != nil {
		return m.EntryPoint
	}
	return 0
...
func (*Header) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*Parameter) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*WebSocketRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*WebSocketResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*BiStreamRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (*BiStreamResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*StreamDataResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
type StreamRequest struct {
	...
	ByteRanges   []*ByteRange `protobuf:"bytes,11,rep,name=ByteRanges" json:"ByteRanges,omitempty"`
	SessionToken string       `protobuf:"bytes,12,opt,name=SessionToken" json:"SessionToken,omitempty"`
}

func (m *StreamRequest) Reset()                    { *m = StreamRequest{} }
func (m *StreamRequest) String() string            { return proto.CompactTextString(m) }
func (*StreamRequest) ProtoMessage()               {}
func (*StreamRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (m *StreamRequest) GetByteRanges() []*ByteRange {
	if m != nil {
		return m.ByteRanges
	}
	return nil
...
func (m *StreamRequest) GetSessionToken() string {
	if m != nil {
...
func (*StreamResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }
...
type StreamDataRequest struct {
	...
	Data      []byte         `protobuf:"bytes,2,opt,name=Data,proto3" json:"Data,omitempty"`
	ByteRange *ByteRange     `protobuf:"bytes,3,opt,name=ByteRange" json:"ByteRange,omitempty"`
}
...
func (*StreamDataRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }
...
func (m *StreamDataRequest) GetByteRange() *ByteRange {
	if m != nil {
		return m.ByteRange
	}
	return nil
...
type ServeRequest struct {
	...
	ByteRanges   []*ByteRange `protobuf:"bytes,10,rep,name=ByteRanges" json:"ByteRanges,omitempty"`
}
...
func (*ServeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (m *ServeRequest) GetByteRanges() []*ByteRange {
	if m != nil {
		return m.ByteRanges
	}
	return nil
...
func (*Cookie) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
type ServeResponse struct {
	...
	ByteRange       *ByteRange `protobuf:"bytes,8,opt,name=ByteRange" json:"ByteRange,omitempty"`
	Headers         []*Header  `protobuf:"bytes,9,rep,name=Headers" json:"Headers,omitempty"`
}
...
func (*ServeResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
func (m *ServeResponse) GetByteRange() *ByteRange {
	if m != nil {
		return m.ByteRange
	}
	return nil
...
func (m *ServeResponse) GetHeaders() []*Header {
	if m != nil {
		return m.Headers
	}
	return nil
...
type AddConfigHTTPRequest struct {
	...
	MaxIdleTime             uint32 `protobuf:"varint,40,opt,name=MaxIdleTime" json:"MaxIdleTime,omitempty"`
	// if this matches, add those authtags to the context
	AddAuthTags []string `protobuf:"bytes,41,rep,name=AddAuthTags" json:"AddAuthTags,omitempty"`
}
...
func (*AddConfigHTTPRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func (m *AddConfigHTTPRequest) GetMaxIdleTime() uint32 {
	if m != nil {
...
func (m *AddConfigHTTPRequest) GetAddAuthTags() []string {
	if m != nil {
		return m.AddAuthTags
	}
	return nil
}
...
func (*RedirectRewrite) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
func (*HostListEntry) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*HostList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*BodyData) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*ConfigureProberRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*ConfigFile) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*GlobalConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (*TCPSession) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (*TCPSessionList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }
...
func (*TCPMetaRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }
...
func init() {
	proto.RegisterType((*ByteRange)(nil), "h2gproxy.ByteRange")
	proto.RegisterType((*BrowserConfig)(nil), "h2gproxy.BrowserConfig")
	...
	proto.RegisterEnum("h2gproxy.Anchor", Anchor_name, Anchor_value)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
