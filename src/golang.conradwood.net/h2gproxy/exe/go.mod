...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3082
	golang.conradwood.net/apis/certmanager v1.1.2978
	golang.conradwood.net/apis/common v1.1.3082
	...
	golang.yacloud.eu/apis/session v1.1.3082
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.3082 // indirect
