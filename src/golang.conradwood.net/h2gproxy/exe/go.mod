...
require (
	...
	golang.conradwood.net/apis/usagestats v1.1.4451
	golang.conradwood.net/apis/weblogin v1.1.4451
	golang.conradwood.net/go-easyops v0.1.39643
	golang.org/x/net v0.51.0
	golang.yacloud.eu/apis/session v1.1.4451
	golang.yacloud.eu/apis/sessionmanager v1.1.4451
...
require (
	...
	golang.yacloud.eu/apis/autodeployer2 v1.1.4451 // indirect
	...
	golang.yacloud.eu/apis/urlcacher v1.1.4451 // indirect
