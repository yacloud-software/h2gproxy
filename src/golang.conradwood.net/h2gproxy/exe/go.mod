...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3634
	golang.conradwood.net/apis/certmanager v1.1.3625
	golang.conradwood.net/apis/common v1.1.3634
	...
	golang.yacloud.eu/apis/session v1.1.3634
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.3634 // indirect
