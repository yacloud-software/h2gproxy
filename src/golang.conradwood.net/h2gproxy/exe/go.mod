...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3601
	golang.conradwood.net/apis/certmanager v1.1.3340
	golang.conradwood.net/apis/common v1.1.3601
	...
	golang.yacloud.eu/apis/session v1.1.3601
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.3601 // indirect
