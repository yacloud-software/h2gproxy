...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3638
	golang.conradwood.net/apis/certmanager v1.1.3625
	golang.conradwood.net/apis/common v1.1.3638
	...
	golang.yacloud.eu/apis/session v1.1.3638
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.3638 // indirect
