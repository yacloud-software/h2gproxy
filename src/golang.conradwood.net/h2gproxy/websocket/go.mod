...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3082 // indirect
	golang.conradwood.net/apis/autodeployer v1.1.3071 // indirect
	golang.conradwood.net/apis/common v1.1.3082 // indirect
	...
	golang.conradwood.net/go-easyops v0.1.29674 // indirect
	golang.org/x/net v0.29.0 // indirect
	golang.org/x/sys v0.25.0 // indirect
	golang.org/x/text v0.18.0 // indirect
	golang.yacloud.eu/apis/fscache v1.1.3071 // indirect
	golang.yacloud.eu/apis/session v1.1.3082 // indirect
