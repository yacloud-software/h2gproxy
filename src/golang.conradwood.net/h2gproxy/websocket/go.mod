...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2897 // indirect
	golang.conradwood.net/apis/autodeployer v1.1.2878 // indirect
	golang.conradwood.net/apis/common v1.1.2897 // indirect
	...
	golang.conradwood.net/go-easyops v0.1.27139 // indirect
