...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3691 // indirect
	golang.conradwood.net/apis/autodeployer v1.1.3625 // indirect
	golang.conradwood.net/apis/common v1.1.3691 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3691 // indirect
