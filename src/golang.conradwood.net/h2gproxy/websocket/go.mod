...
require golang.conradwood.net/apis/h2gproxy v1.1.3603
...
require (
	...
	golang.conradwood.net/apis/common v1.1.3625 // indirect
	...
	golang.conradwood.net/go-easyops v0.1.33682 // indirect
