...
require golang.conradwood.net/apis/h2gproxy v1.1.2810
...
require (
	...
	golang.conradwood.net/go-easyops v0.1.27487 // indirect
	golang.org/x/net v0.24.0 // indirect
	golang.org/x/sys v0.19.0 // indirect
	golang.org/x/text v0.14.0 // indirect
	golang.yacloud.eu/apis/fscache v1.1.2897 // indirect
	golang.yacloud.eu/apis/session v1.1.2915 // indirect
