...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2785
	golang.conradwood.net/apis/certmanager v1.1.2704
	golang.conradwood.net/apis/common v1.1.2785
	...
	golang.yacloud.eu/apis/session v1.1.2785
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.2785 // indirect
