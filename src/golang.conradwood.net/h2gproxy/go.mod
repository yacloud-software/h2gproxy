...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2783
	golang.conradwood.net/apis/certmanager v1.1.2704
	golang.conradwood.net/apis/common v1.1.2783
	...
	golang.yacloud.eu/apis/session v1.1.2783
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.2783 // indirect
