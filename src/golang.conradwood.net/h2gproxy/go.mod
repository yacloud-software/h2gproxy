...
require (
	...
	golang.conradwood.net/apis/antidos v1.1.2491
	golang.conradwood.net/apis/auth v1.1.2491
	golang.conradwood.net/apis/certmanager v1.1.2491
	golang.conradwood.net/apis/common v1.1.2491
	golang.conradwood.net/apis/framework v1.1.2491
	golang.conradwood.net/apis/h2gproxy v1.1.1746
	golang.conradwood.net/apis/registry v1.1.2491
	golang.conradwood.net/apis/rpcinterceptor v1.1.2491
	golang.conradwood.net/apis/usagestats v1.1.2491
	golang.conradwood.net/apis/weblogin v1.1.2491
	golang.conradwood.net/go-easyops v0.1.19057
	golang.org/x/net v0.14.0
	golang.yacloud.eu/apis/session v1.1.2491
	golang.yacloud.eu/apis/sessionmanager v1.1.2491
