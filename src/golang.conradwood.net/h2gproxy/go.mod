...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2650
	golang.conradwood.net/apis/certmanager v1.1.2643
	golang.conradwood.net/apis/common v1.1.2650
	...
	golang.yacloud.eu/apis/session v1.1.2650
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.2650 // indirect
